                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, new Promise(function (resolve) {
                                ...
                                test.on(InputTest_1.InputTest.Events.End, function (_, r) { return resolve(r); });
                            })];
                        case 1:
                            report = _a.sent();
                            return [2 /*return*/];
                    ...
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, new Promise(function (resolve) {
                                InputTest_1.testInputDevice({
                                    ...
                                    getUserMedia: getUserMedia,
                                    pollIntervalMs: defaultPollIntervalMs,
                                }).on(InputTest_1.InputTest.Events.End, function (_, r) { return resolve(r); });
                            })];
                        case 1:
                            report = _a.sent();
                            return [2 /*return*/];
