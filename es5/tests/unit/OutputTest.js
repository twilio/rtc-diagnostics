...
describe('testOutputDevice', function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, new Promise(function (resolve) {
                                ...
                                }).on(OutputTest_1.OutputTest.Events.End, function (r) { return resolve(r); });
                            })];
                        case 1:
                            report = _a.sent();
                            return [2 /*return*/];
    ...
    it('should report if passed normally', function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.all([true, false].map(function (pass) { return (function () { return __awaiter(_this, void 0, void 0, function () {
                            var report;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, new Promise(function (resolve) {
                                            ...
                                            test.on(OutputTest_1.OutputTest.Events.End, resolve);
                                            setTimeout(function () {
                                                test.stop(pass);
                                            }, defaultDuration);
                                        })];
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve) {
                                ...
                                test.on(OutputTest_1.OutputTest.Events.End, function (r) {
                                    result['report'] = r;
                                    if (result.error && result.report) {
                                        resolve(result);
                                    }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, new Promise(function (resolve) {
                                ...
                                test.on(OutputTest_1.OutputTest.Events.End, function (r) { return resolve(r); });
                            })];
                        case 1:
                            report = _a.sent();
                            assert(report);
    ...
    it('should not allow `deviceId` if `setSinkId` is unsupported', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        test = OutputTest_1.testOutputDevice({
                            audioContextFactory: MockAudioContext_1.mockAudioContextFactory(),
                        ...
                        return [4 /*yield*/, Promise.all([
                                new Promise(function (resolve) { return test.on(OutputTest_1.OutputTest.Events.Error, resolve); }),
                                new Promise(function (resolve) { return test.on(OutputTest_1.OutputTest.Events.End, resolve); }),
                            ])];
                    case 1:
                        results = _a.sent();
                        error = results[0];
