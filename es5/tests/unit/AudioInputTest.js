...
var AudioInputTest_1 = require("../../lib/AudioInputTest");
...
function createTestOptions(overrides) {
    ...
    return __assign({ audioContextFactory: MockAudioContext_1.mockAudioContextFactory(), duration: 1000, enumerateDevices: mockEnumerateDevices_1.mockEnumerateDevicesFactory({
            ...
            mediaStream: new MockMediaStream_1.MockMediaStream({
                tracks: [new MockTrack_1.MockTrack({ kind: 'audio' })],
            }),
...
describe('testAudioInputDevice', function () {
    ...
    function createBasicTest(testOptions) {
        var _a;
        var handlers = (_a = {},
            _a[AudioInputTest_1.AudioInputTest.Events.End] = sinon.stub(),
            _a[AudioInputTest_1.AudioInputTest.Events.Error] = sinon.stub(),
            _a[AudioInputTest_1.AudioInputTest.Events.Volume] = sinon.stub(),
            _a[AudioInputTest_1.AudioInputTest.Events.Warning] = sinon.stub(),
            _a[AudioInputTest_1.AudioInputTest.Events.WarningCleared] = sinon.stub(),
            _a);
        var audioInputTest = AudioInputTest_1.testAudioInputDevice(testOptions);
        audioInputTest.on(AudioInputTest_1.AudioInputTest.Events.Error, handlers.error);
        audioInputTest.on(AudioInputTest_1.AudioInputTest.Events.Volume, handlers.volume);
        audioInputTest.on(AudioInputTest_1.AudioInputTest.Events.End, handlers.end);
        audioInputTest.on(AudioInputTest_1.AudioInputTest.Events.WarningCleared, handlers['warning-cleared']);
        audioInputTest.on(AudioInputTest_1.AudioInputTest.Events.Warning, handlers.warning);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        test_1 = AudioInputTest_1.testAudioInputDevice(options);
                        test_1.stop();
                        test_1.stop();
    ...
    describe('in a supported environment', function () {
        it('should properly warn the user when low audio levels should be detected', function () {
            return __awaiter(this, void 0, void 0, function () {
                var testOptions, _a, handlers, audioInputTest, resetHandlers, original;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            _a = createBasicTest(testOptions), handlers = _a.handlers, audioInputTest = _a.audioInputTest, resetHandlers = _a.resetHandlers;
                        ...
                        case 1:
                            ...
                            resetHandlers();
                            original = audioInputTest['_onVolume'].bind(audioInputTest);
                            audioInputTest['_onVolume'] = function () {
                                original(100);
                            };
                            return [4 /*yield*/, clock.tickAsync(5000)];
                        case 2:
