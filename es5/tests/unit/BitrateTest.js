        ...
        describe('after creating successfully', function () {
            ...
            describe('on bitrate', function () {
                ...
                describe('connection timing', function () {
                    ...
                    it('should not raise HighFirstPacketDuration warning', function (done) {
                        var callback = sinon.stub();
                        bitrateTest.on(BitrateTest_1.BitrateTest.Events.Warning, callback);
                        bitrateTest.on(BitrateTest_1.BitrateTest.Events.End, function () {
                            sinon.assert.notCalled(callback);
                            done();
                        });
                        clock.tick(1399);
                    ...
                    it('should raise HighFirstPacketDuration warning', function (done) {
                        var callback = sinon.stub();
                        bitrateTest.on(BitrateTest_1.BitrateTest.Events.Warning, callback);
                        bitrateTest.on(BitrateTest_1.BitrateTest.Events.End, function (report) {
                            sinon.assert.calledWithExactly(callback, BitrateTest_1.BitrateTest.Warnings.HighFirstPacketDuration);
                            assert.deepEqual(report.warnings, [BitrateTest_1.BitrateTest.Warnings.HighFirstPacketDuration]);
                            done();
                        });
                        clock.tick(1400);
                        sendMessage(message);
                    ...
                    it('should not raise HighPcConnectDuration warning', function (done) {
                        var callback = sinon.stub();
                        bitrateTest.on(BitrateTest_1.BitrateTest.Events.Warning, function (name) {
                            if (name !== BitrateTest_1.BitrateTest.Warnings.HighFirstPacketDuration) {
                                callback(name);
                            }
                        });
                        bitrateTest.on(BitrateTest_1.BitrateTest.Events.End, function () {
                    ...
                    it('should raise HighPcConnectDuration warning', function (done) {
                        var callback = sinon.stub();
                        bitrateTest.on(BitrateTest_1.BitrateTest.Events.Warning, function (name) {
                            if (name !== BitrateTest_1.BitrateTest.Warnings.HighFirstPacketDuration) {
                                callback(name);
                        ...
                        bitrateTest.on(BitrateTest_1.BitrateTest.Events.End, function (report) {
                            sinon.assert.calledWithExactly(callback, BitrateTest_1.BitrateTest.Warnings.HighPcConnectDuration);
                            assert.deepEqual(report.warnings, [
                                BitrateTest_1.BitrateTest.Warnings.HighPcConnectDuration,
                                BitrateTest_1.BitrateTest.Warnings.HighFirstPacketDuration,
                            ]);
                            done();
                        });
                        pcSenderContext.connectionState = 'connecting';
                    ...
                    it('should not raise HighIceConnectDuration warning', function (done) {
                        var callback = sinon.stub();
                        bitrateTest.on(BitrateTest_1.BitrateTest.Events.Warning, function (name) {
                            if (name !== BitrateTest_1.BitrateTest.Warnings.HighFirstPacketDuration) {
                                callback(name);
                    ...
                    it('should raise HighIceConnectDuration warning', function (done) {
                        var callback = sinon.stub();
                        bitrateTest.on(BitrateTest_1.BitrateTest.Events.Warning, function (name) {
                            if (name !== BitrateTest_1.BitrateTest.Warnings.HighFirstPacketDuration) {
                                callback(name);
                        ...
                        bitrateTest.on(BitrateTest_1.BitrateTest.Events.End, function (report) {
                            sinon.assert.calledWithExactly(callback, BitrateTest_1.BitrateTest.Warnings.HighIceConnectDuration);
                            assert.deepEqual(report.warnings, [BitrateTest_1.BitrateTest.Warnings.HighIceConnectDuration]);
                            done();
                        });
                        pcSenderContext.iceConnectionState = 'checking';
                        pcSenderContext.oniceconnectionstatechange();
