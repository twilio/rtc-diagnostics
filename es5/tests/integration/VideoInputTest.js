...
describe('testVideoInputDevice', function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve) {
                                var test = VideoInputTest_1.testVideoInputDevice({
                                    duration: defaultTestDuration,
                                });
                                test.on(VideoInputTest_1.VideoInputTest.Events.Error, errorHandler);
                                test.on(VideoInputTest_1.VideoInputTest.Events.End, function (r) {
                                    endHandler(r);
                                    // we want to wait before resolving so we can detect if the end handler
                                    // has been called multiple times
                                    setTimeout(function () { return resolve(); }, defaultTestDuration);
                                });
                            })];
                    case 1:
                        _a.sent();
    ...
    it('should have generated a valid report', function () {
        ...
        assert(report.testName === VideoInputTest_1.VideoInputTest.testName);
