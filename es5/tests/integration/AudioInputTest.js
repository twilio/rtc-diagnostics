...
describe('testAudioInputDevice', function () {
    describe('with a deviceId', function () {
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, new Promise(function (resolve) {
                                    var test = AudioInputTest_1.testAudioInputDevice({
                                        debug: false,
                                        duration: defaultTestDuration,
                                        volumeEventIntervalMs: defaultTestVolumeEventIntervalMs,
                                    });
                                    test.on(AudioInputTest_1.AudioInputTest.Events.Error, errorHandler);
                                    test.on(AudioInputTest_1.AudioInputTest.Events.Volume, volumeHandler);
                                    test.on(AudioInputTest_1.AudioInputTest.Events.End, function (r) {
                                        endHandler(r);
        ...
        it('should have generated a valid report', function () {
            ...
            assert(report.testName === AudioInputTest_1.AudioInputTest.testName);
